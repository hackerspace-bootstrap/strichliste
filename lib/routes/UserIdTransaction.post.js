...
TransactionCreate.prototype.route = function (req, res, next) {
    ...
    if (value < configuration.boundaries.transaction.lower) {
        return next(new errors.ForbiddenError('transaction value of ' + value + ' falls below the negative transaction maximum of ' + configuration.boundaries.transaction.lower));
    }
